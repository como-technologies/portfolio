...
2. **Prescribe** — Record *decisions* and *guidance* in the knowledge base, authored with [adroit](./loop/prescribe.md) and seeded mechanically from the assessment export. [The playbook](./products/playbook.md) *(self-serve)* is the published content product a team clones to start its own corpus.
